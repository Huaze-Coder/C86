...
function sorting(){
    var student_name_sorting = [];
    var length_of_array = name_of_the_student_array.length;
    name_of_the_student_array.sort();
    console.log(name_of_the_student_array);
for(var m = 0; m < length_of_array; m++){
    student_name_sorting.push("<h4>name- " + name_of_the_student_array[m] + "</h4>");
    console.log(student_name_sorting);
}
document.getElementById("display_name_with_commas").innerHTML = student_name_sorting;
var remove_commas = student_name_sorting.join(" ");
console.log(remove_commas);
document.getElementById("display_name_without_commas").innerHTML = remove_commas;}